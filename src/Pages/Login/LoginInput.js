...
import { Button, Icon, ButtonColor, Input, Divider } from "@class101/ui";
  ...
  return (
    <div className="loginBox">
      ...
      <div className="loginInputWrapper">
        <div className="loginInputTitle">
          <h2 className="loginTitle">로그인</h2>
        </div>
        <form>
          <Input label="이메일" placeholder="example@naver.com" fill />
          <Input label="비밀번호" placeholder="********" fill type="password" />
        </form>
        <div className="signUpBox">
          <Link to="/" className="aboutPw">
            비밀번호를 잊으셨나요?
          </Link>
          <Link to="/register" className="aboutPw">
            회원 가입하기
          </Link>
        </div>
        <Button fill color={ButtonColor.ORANGE} className="loginBtn">
          로그인
        </Button>
      ...
      <Button fill className="btn naver">
        <div className="icon">
          <img alt="naverLogo" src="/images/ic-naver-white.png" />
        </div>
        <span>네이버로 시작하기</span>
      </Button>
      ...
      <Button fill className="btn google">
        <span className="icon">
          <img alt="googleLogo" src="/images/ic-google.png" />
        </span>
        <span>구글로 시작하기</span>
      </Button>
        ...
        <div className="icon">
          <svg width="24" height="24" viewBox="0 0 24 24">
            <path
              ...
              fill="#1b1c1d"
              fill-rule="evenodd"
              d="M17.336 12.043c.028 3.003 2.635 4.003 2.664 4.015-.022.07-.417 1.424-1.373 2.823-.828 1.209-1.686 2.413-3.038 2.438-1.33.025-1.757-.788-3.276-.788s-1.994.764-3.251.813c-1.306.05-2.3-1.307-3.134-2.511-1.705-2.465-3.007-6.963-1.258-10 .869-1.508 2.421-2.462 4.106-2.487 1.282-.024 2.492.862 3.276.862.783 0 2.253-1.066 3.8-.91.646.027 2.463.262 3.629 1.969-.094.058-2.167 1.265-2.145 3.775M14.84 4.67c.693-.84 1.16-2.007 1.032-3.169-.999.04-2.207.666-2.923 1.504-.643.743-1.205 1.93-1.053 3.07 1.113.086 2.25-.566 2.944-1.405"
            ></path>
          </svg>
        </div>
        <span>애플로 시작하기</span>
